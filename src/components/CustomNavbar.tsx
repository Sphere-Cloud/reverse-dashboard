...
const CustomNavbar = ({actions}: {actions: any}) => {
    ...
    const getCompanyFromId = async() => {
      ...
      if (!localStorage.getItem("user_company_name")) {
        try {
          ...
          console.error("Error obteniendo la empresa del usuario:", error);
        }
      }
    }
